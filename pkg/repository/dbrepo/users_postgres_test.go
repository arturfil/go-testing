...
func TestPosgresDBRepoGetUser(t *testing.T) {
...
func TestPosgresDBRepoGetUserByEmail(t *testing.T) {
    ...
    if user.ID != 2 {
        t.Errorf("wrong email returned by GetUser; expected admin@example.com but got %d", user.ID)
    }
}
